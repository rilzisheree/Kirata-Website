      ...
      <div className="relative z-10">
        ...
        <AnimatePresence mode="wait">
          {isSent ? (
            ...
            >
              <CheckCircle size={28} className="text-[#a2a7d2]" />
            ...
            >
              ...
              <p className="text-xs text-[#a2a7d2]/60 font-mono tabular-nums">
            ...
            >
              <input
                ...
                maxLength={100}
                className="
                  w-full rounded-lg bg-white/5 border border-white/10 focus:border-[#a2a7d2]/40
              ...
              <div className="relative">
                <textarea
                  ...
                  className={`
                    ...
                    ${overLimit ? 'border-red-500/50' : 'border-white/10 focus:border-[#a2a7d2]/40'}
                    text-white/80 placeholder:text-white/25 text-sm font-mono
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <motion.button
                  ...
                  className="
                    ...
                    bg-[#a2a7d2]/15 hover:bg-[#a2a7d2]/25
                    border border-[#a2a7d2]/20 hover:border-[#a2a7d2]/40
                    text-[#a2a7d2] hover:text-[#b8bcdf]
                    transition-all duration-150
                    disabled:opacity-40 disabled:cursor-not-allowed
                    disabled:hover:bg-[#a2a7d2]/15 disabled:hover:border-[#a2a7d2]/20
                  "
                >
                  {status === 'sending' ? (
                    <>
